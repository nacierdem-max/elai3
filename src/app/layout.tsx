  ...
  return (
    <html lang="tr" className={`${geistSans.variable} ${geistMono.variable} dark`}>
      <body className={geistSans.className}>
        ...
        <script type="module" async src="https://static.rocket.new/rocket-web.js?_cfg=https%3A%2F%2Felai32388back.builtwithrocket.new&_be=https%3A%2F%2Fappanalytics.rocket.new&_v=0.1.18" />
